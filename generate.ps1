...
&"D:/dev/Cheez/CheezLang/Tools/CheezCBindingGenerator/bin/x64/CheezCBindingGenerator.exe" vulkan.lua "./int"
Write-Host ""
&"D:/dev/Cheez/CheezLang/Tools/CheezCBindingGenerator/bin/x64/CheezCBindingGenerator.exe" spirv_cross.lua "./int"
Write-Host ""
