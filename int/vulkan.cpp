...
extern "C" void __c__vkGetInstanceProcAddr(PFN_vkVoidFunction *ret, VkInstance_T * _instance, const char * _pName) {
    *ret = (PFN_vkVoidFunction )vkGetInstanceProcAddr(_instance, _pName);
}
extern "C" void __c__vkGetDeviceProcAddr(PFN_vkVoidFunction *ret, VkDevice_T * _device, const char * _pName) {
...
extern "C" void __c__vkEnumerateInstanceExtensionProperties(VkResult *ret, const char * _pLayerName, uint32_t * _pPropertyCount, VkExtensionProperties * _pProperties) {
    *ret = (VkResult )vkEnumerateInstanceExtensionProperties(_pLayerName, _pPropertyCount, _pProperties);
}
extern "C" void __c__vkEnumerateDeviceExtensionProperties(VkResult *ret, VkPhysicalDevice_T * _physicalDevice, const char * _pLayerName, uint32_t * _pPropertyCount, VkExtensionProperties * _pProperties) {
...
extern "C" void __c__vkCmdSetBlendConstants(VkCommandBuffer_T * _commandBuffer, const float * _blendConstants) {
